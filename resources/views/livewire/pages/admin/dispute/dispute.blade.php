                                    ...
                                    @foreach($disputes as $dispute)
                                        <tr>
                                            ...
                                            <td data-label="{{ __('dispute.student' )}}">
                                                <div class="am-list-wrap">
                                                    <figure>
                                                        @if (!empty($dispute?->booking?->student?->image) && Storage::disk('public')->exists($dispute?->booking?->student?->image))
                                                        <img src="{{ resizedImage($dispute?->booking?->student?->image,34,34) }}" alt="{{$dispute?->booking?->student?->image}}" />
                                                        @else
                                                            <img src="{{ setting('_general.default_avatar_for_user') ? asset('storage/' . setting('_general.default_avatar_for_user')[0]['path']) : resizedImage('placeholder.png', 34, 34) }}" alt="{{ $dispute?->booking?->student?->image}}" />
                                                        @endif
                                                    </figure>
                                                    <span>
                                                        <span>
                                            ...
                                            <td data-label="{{ __('dispute.tutor' )}}">
                                                <div class="am-list-wrap">
                                                    <figure>
                                                        @if (!empty($dispute?->booking?->tutor?->image) && Storage::disk('public')->exists($dispute?->booking?->tutor?->image))
                                                        <img src="{{ resizedImage($dispute?->booking?->tutor?->image,34,34) }}" alt="{{$dispute?->booking?->tutor?->image}}" />
                                                        @else 
                                                            <img src="{{ setting('_general.default_avatar_for_user') ? asset('storage/' . setting('_general.default_avatar_for_user')[0]['path']) : resizedImage('placeholder.png',34,34) }}" alt="{{ $dispute?->booking?->tutor?->image }}" />
                                                        @endif
                                                    </figure>
                                                    <span>
                                                        <span>
