                ...
                <div class="col-12" x-data="{
                    ...
                    <div class="am-checkout_box">
                        <div class="am-checkout_methods">
                            ...
                            @if($available_payment_methods || (\Nwidart\Modules\Facades\Module::has('subscriptions') && \Nwidart\Modules\Facades\Module::isEnabled('subscriptions') && !empty($subscriptions)) || $walletBalance)
