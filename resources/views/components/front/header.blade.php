                ...
                <div class="col-12">
                    <div class="am-header_two_wrap am-header-bg">
                        ...
                        <div class="custom-btn-container">
                                ...
                                <a href="{{ route('register') }}" class="btn-tutor">{{ __('general.be_a_tutor') }}</a>
                                <a href="{{ route('login') }}" class="btn-user"><i class="am-icon-user-cross-1"></i></a>
                            </div>
                        @endguest
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="am-header_two_wrap">
                        ...
                        <div class="am-loginbtns">
                            @guest
                                <a href="{{ route('register') }}" class="am-btn">{{ __('general.login') }}</a>
                            @endguest
                            ...
                            <div class="am-sidebar-menu offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                                ...
                                <div class="offcanvas-body">
                                    ...
                                    @guest
                                        <div class="am-btns">
                                            <a href="{{ route('register') }}" class="am-btn am-joinnow-btn">{{ __('general.login') }}</a>
                                            <a href="{{ route('login') }}" class="am-btn"><i class="am-icon-user-cross-1"></i></a>
                                        </div>
                                    @endguest
                                </div>
                            </div>
