                                ...
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    @if(!empty(pagesetting('student_repeater')))
                                        @foreach(pagesetting('student_repeater') as $key => $option)
                                            @if($loop->odd)
                                            <div class="am-works_info am-bg-{{ $loop->index }}">
                                                    <div>
                                                        ...
                                                        <div class="am-works_info_description">
                                                            @if(!empty($option['student_sub_heading'])) 
                                                                ...
                                                                @endif
                                                            @endif
                                                            @if(!empty($option['student_heading'])) <h3 class="h3-{{ $loop->index }}">{!! $option['student_heading'] !!}</h3> @endif
                                                            @if(!empty($option['student_paragraph'])) <p class="p-{{ $loop->index }}">{!! $option['student_paragraph'] !!}</p> @endif
                                                        </div>
                                                    </div>
