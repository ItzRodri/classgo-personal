...
class PageBuilderService {
    ...
    public function getEasyStepsData($pageId)
    {
        ...
        if($page->slug == 'home-three' || $page->slug == 'home-four' || $page->slug == 'home-seven'){
    ...
    public function getGetAppData($pageId)
    {
        ...
        if($page->slug == 'home-three' || $page->slug == 'home-four' || $page->slug == 'home-six' || $page->slug == 'home-seven' || $page->slug == 'home-eight'){
    ...
    public function getCategoriesV2($page, $sectionId)
    {
        ...
        return [
            'section_title_variation'   => ['value' => $page->slug == 'home-eight' ? 'am-title-varient-one' : '', 'is_array' => 0],
