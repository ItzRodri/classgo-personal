...
class UpdateBlog extends Component
{
    ...
    public function update()
    {
        ...
        if ($this->image) {
            ...
            $this->image->storeAs('public/blogs', $randomString . '.' . $this->image->getClientOriginalExtension());
            $validatedData['image'] = 'blogs/' . $randomString . '.' . $this->image->getClientOriginalExtension();
            $this->image->storeAs('public/blogs', $this->image->getClientOriginalName());
            $validatedData['image'] = 'blogs/' . $this->image->getClientOriginalName();
        }
