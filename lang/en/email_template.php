...
return [
    ...
    'registration_student_subject' => 'Welcome to ClassGo, {userName}!',
    'registration_tutor_subject' => 'Welcome to ClassGo, {userName}!',
    'registration_admin_subject' => 'New User Registration Notification',
    'greeting' => 'Dear :userName,',
    'greeting_admin' => 'Dear Admin,',
    'registration_student_content' => 'We are excited to have you join the ClassGo community, :userName! Please verify your email address by clicking the following link: :verificationLink We are looking forward to seeing you thrive and achieve your learning goals.',
    'registration_tutor_content' => 'We are thrilled to welcome you as a tutor on ClassGo, :userName! To complete your registration, please verify your email address by clicking the following link: :verificationLink We are excited to see the positive impact you will make on your students\' learning journeys.',
    ...
    'identity_verification_request_content' => 'Thank you for submitting your identity verification request on the ClassGo platform. Our admin team will review your information shortly.<br> Name: {userName} <br> Role: {userRole} <br> Email: {userEmail} <br> Date of Request: {requestDate} <br> You will receive a confirmation email once your identity is verified. If we need any additional details, we will reach out to you directly.',
    'identity_verification_request_admin_subject' => 'New Identity Verification Request',
    'identity_verification_request_admin_content' => 'A new identity verification request has been submitted on the ClassGo platform. Please find the details of the user below: <br> Name: {userName} <br> Role: {userRole} <br> Email: {userEmail} <br> Date of Request: {requestDate} <br> Please proceed with the necessary steps to verify the identity of this user.',
    ...
    'session_booking_student_subject' => 'Thank you for booking with ClassGo!',
    'session_booking_student_content' => 'We’re excited to confirm your upcoming sessions. Here are the details for each of your bookings <br> :bookingDetails <br> Thanks for choosing ClassGo! We’re here to help you reach your learning goals.',
    'session_booking_tutor_subject' => 'Thank you for booking with ClassGo!',
    'session_booking_tutor_content' => 'We’re excited to confirm your upcoming sessions. Here are the details for each of your bookings <br> :bookingDetails <br> Thanks for choosing ClassGo! We’re here to help you reach your learning goals.',
    ...
    'accepted_withdraw_request_content' => 'Good news, :userName! Your request to withdraw :withdrawAmount from your wallet has been approved. The amount will be credited to your account shortly. Thank you for being a valued member of the ClassGo community.',
    ...
    'admin_dispute_tutor_content' => 'A new dispute has been submitted for the session between {studentName} and {tutorName}. Below are the dispute details:<br><br>Session Details:<br>Tutor: {tutorName}<br>Student: {studentName}<br>Date & Time: {sessionDateTime}<br>Dispute Reason: {disputeReason}<br><br>Please review the case and take appropriate action.<br><br>Best regards,<br>The ClassGo Team',
    ...
    'dispute_resolved_student_content' => 'Dear :studentName,<br>Your dispute for the session with :tutorName has been resolved in your favor. A refund of :refundAmount has been issued to your original payment method.<br>Session Details: <br>Message: :disputeReason <br> Tutor: :tutorName<br>Date & Time: :sessionDateTime<br>Refund Issued: :refundAmount<br><br>Thank you for your patience.<br><br>Best regards,<br>The ClassGo Team',
    ...
    'dispute_resolved_tutor_content' => 'Dear :tutorName,<br>The dispute raised for the session with :studentName has been resolved in your favor. The payment for the session has been released to your wallet.<br>Session Details: <br>Message: :disputeReason <br>Student: :studentName<br>Date & Time: :sessionDateTime<br>Payment Released: :paymentAmount<br><br>Thank you for your patience during the review process.<br><br>Best regards,<br>The ClassGo Team',
