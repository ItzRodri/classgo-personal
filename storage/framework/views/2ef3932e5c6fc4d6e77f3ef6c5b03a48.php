    ...
    <nav class="am-navigation">
        <ul>
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <li class="<?php echo \Illuminate\Support\Arr::toCssClasses(['am-active-nav' => in_array($activeRoute, $item['onActiveRoute'])]); ?>">
...
</script><?php /**PATH /home/lexhwdfc/public_html/resources/views/livewire/pages/common/navigation.blade.php ENDPATH**/ ?>