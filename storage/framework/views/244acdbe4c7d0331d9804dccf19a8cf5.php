...
unset($__errorArgs, $__bag); ?>" placeholder="<?php echo e(__('settings.fixed_price_placeholder')); ?>">
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['fix_fixed_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" placeholder="<?php echo e(__('settings.percentage_amount_placeholder')); ?>">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['per_fixed_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
</main><?php /**PATH /home/lexhwdfc/public_html/resources/views/livewire/pages/admin/payments/commission-settings.blade.php ENDPATH**/ ?>