...
<div class="am-header_user">
    <!--[if BLOCK]><![endif]--><?php if($multiLang): ?>
...
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if (\Illuminate\Support\Facades\Blade::check('hasanyrole', $cartRole)): ?>
        <div
            class="am-orderwrap"
            x-data="{
                showCart: false,
                ...
                <template x-if="cartData.length > 0">
                    <div class="am-ordersummary_content">
                        ...
                        <ul class="am-ordersummary_price">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if(\Nwidart\Modules\Facades\Module::has('kupondeal') && \Nwidart\Modules\Facades\Module::isEnabled('kupondeal')): ?>
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    <!--[if BLOCK]><![endif]--><?php if($showMessage): ?>
    <!--[if BLOCK]><![endif]--><?php if (\Illuminate\Support\Facades\Blade::check('hasanyrole', 'tutor|student')): ?>
    <a href="<?php echo e(route('laraguppy.messenger')); ?>" class="am-header_user_chat">
        <i class="am-icon-chat-03"></i>
        <?php
            $message = getUnreadMsgsCount();
        ?>
        <!--[if BLOCK]><![endif]--><?php if($message > 0): ?>
        ...
        <ul>
            <li>
                <div class="am-user_info">
                    <figure>
                        <!--[if BLOCK]><![endif]--><?php if(auth()->user()->hasRole('tutor')): ?>
            ...
            <?php elseif (\Illuminate\Support\Facades\Blade::check('role', 'tutor')): ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if(\Nwidart\Modules\Facades\Module::has('forumwise') && \Nwidart\Modules\Facades\Module::isEnabled('forumwise')): ?>
                    <li>
...
</div><?php /**PATH /home/lexhwdfc/public_html/resources/views/components/frontend/user-menu.blade.php ENDPATH**/ ?>