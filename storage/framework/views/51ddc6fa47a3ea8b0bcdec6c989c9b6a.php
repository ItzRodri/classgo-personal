...
<?php endif; ?>
        ...
        <?php if( !empty(setting('_general.enable_rtl')) || !empty(session()->get('rtl')) ): ?>
            <link rel="stylesheet" type="text/css" href="<?php echo e(asset('admin/css/rtl.css')); ?>?v=<?php echo e(time()); ?>"
            <?php if(\Nwidart\Modules\Facades\Module::has('forumwise') && \Nwidart\Modules\Facades\Module::isEnabled('forumwise')): ?>
                <link rel="stylesheet" type="text/css" href="<?php echo e(asset('modules/forumwise/css/rtl.css')); ?>?v=<?php echo e(time()); ?>">
            <?php endif; ?>
        <?php endif; ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1824873433-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /home/lexhwdfc/public_html/resources/views/layouts/admin-app.blade.php ENDPATH**/ ?>