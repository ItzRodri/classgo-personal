...
<?php echo $__env->make(!empty(config('laraguppy.layout')) ? config('laraguppy.layout') : 'laraguppy::layouts.messenger', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lexhwdfc/public_html/vendor/amentotech/laraguppy/src/../resources/views/messenger.blade.php ENDPATH**/ ?>