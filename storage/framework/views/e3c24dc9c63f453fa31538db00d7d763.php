...
$__html = app('livewire')->mount($__name, $__params, 'lw-1847623632-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1847623632-1', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1847623632-2', $__slots ?? [], get_defined_vars());
                ...
                <main class="am-main">
                    <div class="am-dashboard_box">
                        <div class="am-dashboard_box_wrap">
                            ...
                            <?php if(setting('_api.active_conference') == 'google_meet' && empty(isCalendarConnected(Auth::user()))): ?>
...
<?php /**PATH /home/lexhwdfc/public_html/resources/views/layouts/app.blade.php ENDPATH**/ ?>