                                        ...
                                        <td data-label="<?php echo e(__('general.account_detail' )); ?>">
                                            <ul class="tb-action-status">
                                                <li>
                                                    ...
                                                    <span>
                                                        <a href="javascript:;"  @click="$wire.dispatch('showConfirm', { id : <?php echo e($single->id); ?>, action : 'approve-request' })"><i class="fas fa-check"></i><?php echo e(__('project.approve')); ?></a>
                                                    </span>
                                                    <?php else: ?>
...
</Script><?php /**PATH /home/lexhwdfc/public_html/resources/views/livewire/pages/admin/payments/withdraw-request.blade.php ENDPATH**/ ?>