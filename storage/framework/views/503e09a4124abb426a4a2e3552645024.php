...
<?php endif; ?>
                        ...
                        <nav class="am-navigation navbar-expand-xxl">
                            
                            <div class="am-navbar-toggler">
                                <div  class="navbar-toggler" data-bs-toggle="collapse" data-bs-target="#tenavbar" aria-expanded="true" aria-label="Toggle navigation" role="button">
                                </div>
...
<?php endif; ?>
                        ...
                        <div class="custom-btn-container">
                                ...
                                <a href="<?php echo e(route('register')); ?>" class="btn-tutor"><?php echo e(__('general.be_a_tutor')); ?></a>
                                <a href="<?php echo e(route('login')); ?>" class="btn-user"><i class="am-icon-user-cross-1"></i></a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php endif; ?>
                        ...
                        <div class="am-loginbtns">
                            <?php if(auth()->guard()->guest()): ?>
                                <a href="<?php echo e(route('register')); ?>" class="am-btn"><?php echo e(__('general.login')); ?></a>
                            <?php endif; ?>
...
<?php endif; ?>
                                    ...
                                    <?php if(auth()->guard()->guest()): ?>
                                        <div class="am-btns">
                                            <a href="<?php echo e(route('register')); ?>" class="am-btn am-joinnow-btn"><?php echo e(__('general.login')); ?></a>
                                            <a href="<?php echo e(route('login')); ?>" class="am-btn"><i class="am-icon-user-cross-1"></i></a>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
...
<?php endif; ?>
                        ...
                        <div class="custom-btn-container">
                                ...
                                <a href="<?php echo e(route('register')); ?>" class="btn-tutor"><?php echo e(__('general.be_a_tutor')); ?></a>
                                <a href="<?php echo e(route('login')); ?>" class="btn-user">
                                    <i class="am-icon-user-cross-1"></i> 
                                </a>
                            </div>
                        <?php endif; ?>
                    </div>
...
<?php endif; ?>
<?php /**PATH /home/lexhwdfc/public_html/resources/views/components/front/header.blade.php ENDPATH**/ ?>