            ...
            <div class="am-session-detail_sidebar">
                <div class="am-session-detail_content">
                    <span>
                        ...
                        <span><?php echo e($currentBooking?->slot?->subjectGroupSubjects?->group?->name); ?></span>
                    </span>
                    <div class="am-closepopup" data-bs-dismiss="modal">
                        <i class="am-icon-multiply-01"></i>
                    </div>
                    <h4><?php echo e($currentBooking?->slot?->subjectGroupSubjects?->subject?->name); ?></h4>
                </div>
                <ul class="am-session-duration">
                    <li>
                        ...
                        <strong class="<?php echo \Illuminate\Support\Arr::toCssClasses(['am-rescheduled' =>  auth()->user()->role == 'student' && $currentBooking?->status == 'rescheduled']); ?>"><?php echo e(parseToUserTz($currentBooking?->slot?->start_time)->format(setting('_general.date_format') ?? 'F j, Y')); ?></strong>
                    </li>
                    <li>
                        <div class="am-session-duration_title">
                        ...
                        <strong class="<?php echo \Illuminate\Support\Arr::toCssClasses(['am-rescheduled' => auth()->user()->role == 'student' && $currentBooking?->status == 'rescheduled']); ?>">
                            <!--[if BLOCK]><![endif]--><?php if(setting('_lernen.time_format') == '12'): ?>
                                <?php echo e(parseToUserTz($currentBooking?->slot?->start_time)->format('h:i a')); ?> -
                                <?php echo e(parseToUserTz($currentBooking?->slot?->end_time)->format('h:i a')); ?>

                            <?php else: ?>
                                <?php echo e(parseToUserTz($currentBooking?->slot?->start_time)->format('H:i')); ?> -
                                <?php echo e(parseToUserTz($currentBooking?->slot?->end_time)->format('H:i')); ?>
                    ...
                    <li>
                        ...
                        <strong>
                            <!--[if BLOCK]><![endif]--><?php if (\Illuminate\Support\Facades\Blade::check('role', 'tutor')): ?> <em><?php echo e(__('calendar.you')); ?></em> <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
...
<?php /**PATH /home/lexhwdfc/public_html/resources/views/components/booking-detail-modal.blade.php ENDPATH**/ ?>