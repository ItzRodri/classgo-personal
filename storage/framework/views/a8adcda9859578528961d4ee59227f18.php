<div class="am-userinfo_section"  wire:init="loadPage" x-data="{
    ...
    <!--[if BLOCK]><![endif]--><?php if(empty($pageLoaded)): ?>
        <div class="am-booking-skeleton">
            <?php echo $__env->make('skeletons.book-sessions', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    <?php else: ?>
                                                            ...
                                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $slots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                ...
                                                                <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['d-none' => $index > 3, 'am-slot-selected' => in_array($slot->id, $cartItemIds), 'am-weekly-slots_card', 'am-slot-'.$tooltipClass]); ?>" id="sessionslot-<?php echo e($slot->id); ?>">
                                                                    ...
                                                                    <div class="am-bookingbtns">
                                                                        <!--[if BLOCK]><![endif]--><?php if(((Auth::check() && Auth()->user()->role == 'student') && !in_array($slot->id, $cartItemIds) && $available_slot > 0) && $slot->bookings->isEmpty()): ?>
...
unset($__errorArgs, $__bag); ?>>
                                    <label class="am-label am-important2" for="name"><?php echo e(__('auth.first_name')); ?></label>
...
unset($__errorArgs, $__bag); ?>>
                                    <label class="am-label am-important2" for="email"><?php echo e(__('auth.last_name')); ?></label>
...
unset($__errorArgs, $__bag); ?>">
                                <label class="am-label am-important2" for="email"><?php echo e(__('auth.email_placeholder')); ?></label>
...
unset($__errorArgs, $__bag); ?>">
                                <label class="am-label am-important2" for="email"><?php echo e(__('tutor.message')); ?></label>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/lexhwdfc/public_html/resources/views/livewire/components/tutor-sessions.blade.php ENDPATH**/ ?>