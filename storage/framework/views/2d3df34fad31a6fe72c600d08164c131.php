              ...
              <div class="am-hero-container">
                <div class="am-hero-background">
                  <?php if(!empty($option['bg_image_one'])): ?>
                    <img src="<?php echo e(asset('storage/'.$option['bg_image_one'][0]['path'])); ?>" alt="Banner slice first image" class="image slice slice1">
                  <?php endif; ?>
                  <?php if(!empty($option['bg_image_two'])): ?>
                    <img src="<?php echo e(asset('storage/'.$option['bg_image_two'][0]['path'])); ?>" alt="Banner slice second image" class="image slice slice2">
                  <?php endif; ?>
                  <?php if(!empty($option['bg_image_three'])): ?>
                    <img src="<?php echo e(asset('storage/'.$option['bg_image_three'][0]['path'])); ?>" alt="Banner slice third image" class="image slice slice3">
                  <?php endif; ?>
                </div>
                      ...
                      <?php if(!empty($option['companies_images'])): ?>
                        <?php $__currentLoopData = $option['companies_images']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php if(!empty($image['path'])): ?>
                            <img src="<?php echo e(asset('storage/'.$image['path'])); ?>" alt="Company image" class="am-partner-logo">
                          <?php endif; ?>
...
<?php if (! $__env->hasRenderedOnce('037fe445-5759-429d-aa32-c579ef822202')): $__env->markAsRenderedOnce('037fe445-5759-429d-aa32-c579ef822202');
...
<?php /**PATH /home/lexhwdfc/public_html/resources/views/pagebuilder/banner-v8/view.blade.php ENDPATH**/ ?>