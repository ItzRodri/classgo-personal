<div class="am-profile-setting">
    ...
    <div wire:target="switchShow,jumpToDate,nextBookings,previousBookings,filter"
         class="am-booking-wrapper am-upcomming-booking <?php if (\Illuminate\Support\Facades\Blade::check('role', 'student')): ?> am-student-booking <?php endif; ?>" x-data="{
                            ...
                            <tbody>
                                ...
                                <!--[if BLOCK]><![endif]--><?php while($startTime <= $endTime): ?> <tr>
                                    ...
                                    <td>
                                        ...
                                        <div
                                            style="position: relative; top: <?php echo e(calculatePercentageOfHour($booking->slot->start_time)); ?>px;<?php if(!$loop->first): ?>left: 380px;<?php endif; ?>">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php for($i = 0; $i < 7; $i++): ?> <?php $totalBookings=0; ?> <td
                                        ...
                                        <ul class="am-monthly-session-lsit">
                                            ...
                                            <li class="<?php echo \Illuminate\Support\Arr::toCssClasses([ "am-$tooltipClass-tooltip"=>
                                                ...
                                                <div class="am-titleblur">
                                                    <div class="am-session-monthly-tooltip">
                                                        <strong wire:loading.class="am-btn_disable"
                                                            wire:click="showBookingDetail(<?php echo e($booking->id); ?>)"><?php echo e($subject); ?></strong>
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php if(auth()->user()->role == 'student' && $booking->status ==
                                                'rescheduled'): ?>
...
<script>
    ...
    ?><?php /**PATH /home/lexhwdfc/public_html/resources/views/livewire/pages/common/bookings/user-booking.blade.php ENDPATH**/ ?>