            ...
            <div class="tb-dbholder tb-packege-setting">
                <div class="tb-dbbox tb-dbboxtitle">
                    <!--[if BLOCK]><![endif]--><?php if($editMode): ?>
                        <h5> <?php echo e(__('taxonomy.update_subject_group')); ?></h5>
                    <?php else: ?>
                        <h5> <?php echo e(__('taxonomy.add_subject_group')); ?></h5>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($editMode): ?>
                                    <div class="form-group">
                                        ...
                                        <div class="tb-email-status">
                                            <span><?php echo e(__('taxonomy.subject_group_status')); ?></span>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div class="form-group tb-dbtnarea">
                                    <a href="javascript:void(0);" wire:click.prevent="update" class="tb-btn ">
                                        <!--[if BLOCK]><![endif]--><?php if($editMode): ?>
                                            <?php echo e(__('taxonomy.update_subject_group')); ?>
        ...
        <div class="col-lg-8 col-md-12 tb-md-60">
            <div class="tb-dhb-mainheading">
                <h4> <?php echo e(__('taxonomy.subject_groups')); ?></h4>
                <div class="tb-sortby">
                    <form class="tb-themeform tb-displistform">
                        <fieldset>
                            <div class="tb-themeform__wrap">
                                <div class="tb-actionselect">
                                    <a href="javascript:;" class="tb-btn btnred <?php echo e($selectedSubjectGroups ? '' : 'd-none'); ?>"  @click="$wire.dispatch('showConfirm', { action : 'delete-subject-group' })" ><?php echo e(__('general.delete_selected')); ?></a>
                                </div>
                                <div class="tb-actionselect">
                                    <div class="tb-select">
            ...
            <div class="tb-disputetable tb-pageslanguage">
                <!--[if BLOCK]><![endif]--><?php if(!empty($subjectGroups) && $subjectGroups->count() > 0): ?>
                    <table class="table tb-table tb-dbholder <?php if(setting('_general.table_responsive') == 'yes'): ?> tb-table-responsive <?php endif; ?>">
                        ...
                        <tbody>
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $subjectGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $single): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td data-label="<?php echo e(__('taxonomy.name')); ?>">
                                        <div class="tb-checkboxwithimg">
                                            <div class="tb-checkbox">
                                                <input id="subject_group_id<?php echo e($single->id); ?>" wire:model.lazy="selectedSubjectGroups" value="<?php echo e($single->id); ?>" type="checkbox">
                                                <label for="subject_group_id<?php echo e($single->id); ?>">
                                                    <span>
                                    ...
                                    <td data-label="<?php echo e(__('general.actions')); ?>">
                                        <ul class="tb-action-icon">
                                            ...
                                            <li> <a href="javascript:void(0);" @click="$wire.dispatch('showConfirm', { id : <?php echo e($single->id); ?>, action : 'delete-subject-group' })"  class="tb-delete"><i class="icon-trash-2"></i></a> </li>
                                        </ul>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <?php echo e($subjectGroups->links('pagination.custom')); ?>
...
</main><?php /**PATH /home/lexhwdfc/public_html/resources/views/livewire/pages/admin/taxonomy/subject-groups.blade.php ENDPATH**/ ?>