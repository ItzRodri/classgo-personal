                                ...
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    <?php if(!empty(pagesetting('student_repeater'))): ?>
                                        <?php $__currentLoopData = pagesetting('student_repeater'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($loop->odd): ?>
                                            <div class="am-works_info am-bg-<?php echo e($loop->index); ?>">
                                                    <div>
                                                        ...
                                                        <div class="am-works_info_description">
                                                            <?php if(!empty($option['student_sub_heading'])): ?> 
                                                                <?php if($option['student_sub_heading'] == 'Sign Up'): ?>
                                                                    <span><a href="register"><?php echo e($option['student_sub_heading']); ?></a></span> 
                                                                <?php else: ?>
                                                                    <span><?php echo e($option['student_sub_heading']); ?></span> 
                                                                <?php endif; ?>
                                                            <?php endif; ?>
                                                            <?php if(!empty($option['student_heading'])): ?> <h3 class="h3-<?php echo e($loop->index); ?>"><?php echo $option['student_heading']; ?></h3> <?php endif; ?>
                                                            <?php if(!empty($option['student_paragraph'])): ?> <p class="p-<?php echo e($loop->index); ?>"><?php echo $option['student_paragraph']; ?></p> <?php endif; ?>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="am-works_info_description">
                                                            <?php if(!empty($option['tutor_sub_heading'])): ?> 
                                                                <?php if($option['tutor_sub_heading'] == 'Sign Up'): ?>
                                                                    <span><a href="register"><?php echo e($option['tutor_sub_heading']); ?></a></span> 
                                                                <?php else: ?>
...
<?php /**PATH /home/lexhwdfc/public_html/resources/views/pagebuilder/how-it-works/view.blade.php ENDPATH**/ ?>