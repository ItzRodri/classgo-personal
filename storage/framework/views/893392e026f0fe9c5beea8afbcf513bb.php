            ...
            <div class="am-banner-main">
                <div class="am-banner-tutor">
                    <?php if(!empty(pagesetting('first_heading')) || !empty(pagesetting('second_heading')) || !empty(pagesetting('paragraph'))): ?>
                        ...
                        <?php if(!empty(pagesetting('paragraph'))): ?><p data-aos="fade-up" data-aos-easing="ease" data-aos-delay="600"><?php echo e(pagesetting('paragraph')); ?></p><?php endif; ?>
                    <?php endif; ?>
                                    ...
                                    <ul>
                                        <?php $__currentLoopData = pagesetting('image_repeater'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if(!empty($option['user_review_img'])): ?>
                                                <?php if(!empty($option['user_review_img'][0]['path'])): ?><li cla><img src="<?php echo e(url(Storage::url($option['user_review_img'][0]['path']))); ?>" alt="Users image"></li><?php endif; ?>
                                            <?php endif; ?>
...
<?php if (! $__env->hasRenderedOnce('d4cb0208-45d0-4b44-8e2a-21a04a5d61d6')): $__env->markAsRenderedOnce('d4cb0208-45d0-4b44-8e2a-21a04a5d61d6');
...
<?php if (! $__env->hasRenderedOnce('d29733c8-1fc8-4886-ab19-00802ae36ee6')): $__env->markAsRenderedOnce('d29733c8-1fc8-4886-ab19-00802ae36ee6');
...
<?php $__env->stopPush(); endif; ?><?php /**PATH /home/lexhwdfc/public_html/resources/views/pagebuilder/banner-v6/view.blade.php ENDPATH**/ ?>