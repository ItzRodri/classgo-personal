                    ...
                    <?php if(!empty(pagesetting('students_faqs_data')) || !empty(pagesetting('tutors_faqs_data'))): ?>
                        <div class="am-faq">
                            <div class="am-faq-page">
                             ...
                             <div class="am-faq-image">
            <img src="<?php echo e(asset('images/Tugo_Ing.Sistemas.png')); ?>" alt="Descripción de la imagen">
...
<?php /**PATH /home/lexhwdfc/public_html/resources/views/pagebuilder/faqs/view.blade.php ENDPATH**/ ?>