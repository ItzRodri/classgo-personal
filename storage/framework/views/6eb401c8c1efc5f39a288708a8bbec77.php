                                ...
                                <ul class="am-tutorreviews-list">
                                    <li>
                                        <div class="am-tutorreview-item">
                                            ...
                                            <span class="am-uniqespace"><?php echo e(formatAmount($item->min_price)); ?> <em><?php echo e(__('tutor.session_text')); ?></em></span>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="am-tutorreview-item">
                                    ...
                                    <li>
                                        <div class="am-tutorreview-item">
                                            ...
                                            <span> <?php echo e($item->subjects->sum('sessions')); ?> <em><?php echo e($item->subjects->sum('sessions') == 1 ? __('tutor.session') : __('tutor.sessions',)); ?></em></span>
                                        </div>
                                    </li>
...
</div><?php /**PATH /home/lexhwdfc/public_html/resources/views/livewire/components/similar-tutors.blade.php ENDPATH**/ ?>