                ...
                <table class="am-table <?php if(setting('_general.table_responsive') == 'yes'): ?> am-table-responsive <?php endif; ?>">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(!$isLoading): ?>
                        <tbody class="d-none" wire:loading.class.remove="d-none" wire:target="status,keyword">
                            <?php echo $__env->make('skeletons.dispute', ['perPage' => $perPage], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </tbody>
                                ...
                                <tr>
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if (\Illuminate\Support\Facades\Blade::check('role', 'student')): ?>
                                        <td data-label="<?php echo e(__('dispute.tutor')); ?>">
                                            <div class="am-list-wrap ">
                                                <figure>
                                                    <!--[if BLOCK]><![endif]--><?php if(!empty($dispute?->responsibleBy?->profile?->image) && Storage::disk('public')->exists($dispute?->responsibleBy?->profile?->image)): ?>
                                                    ...
                                                    <?php else: ?>
                                                        <img src="<?php echo e(setting('_general.default_avatar_for_user') ? asset('storage/' . setting('_general.default_avatar_for_user')[0]['path']) : resizedImage('placeholder.png', 34, 34)); ?>" alt="<?php echo e($dispute?->responsibleBy?->profile?->image); ?>" />
                                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                </figure>
                                        ...
                                        <td data-label="<?php echo e(__('dispute.student')); ?>">
                                            <div class="am-list-wrap">
                                                <figure>
                                                    ...
                                                    <?php else: ?>
                                                        <img src="<?php echo e(setting('_general.default_avatar_for_user') ? asset('storage/' . setting('_general.default_avatar_for_user')[0]['path']) : resizedImage('placeholder.png', 34, 34)); ?>" alt="<?php echo e($dispute?->creatorBy?->profile?->image); ?>" />
                                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                </figure>
...
</div><?php /**PATH /home/lexhwdfc/public_html/resources/views/livewire/pages/common/dispute/dispute.blade.php ENDPATH**/ ?>