<ul class="am-userperinfo_tab">
    ...
    <!--[if BLOCK]><![endif]--><?php if(auth()->user()->role == 'tutor' || $isIdentity == 'both'): ?>
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</ul><?php /**PATH /home/lexhwdfc/public_html/resources/views/livewire/pages/common/profile-settings/tabs.blade.php ENDPATH**/ ?>