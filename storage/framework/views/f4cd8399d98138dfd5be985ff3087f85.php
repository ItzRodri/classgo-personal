<div class="am-insights-wrapper tb-custom-scrollbar">
    <div class="am-insights">
        <div class="am-insights_section am-revenue">
            <div class="am-insights_header">
                <div class="am-insights_title">
                    <h2><?php echo e(__('admin/general.revenue_payment_metrics')); ?></h2>
                    <p><?php echo e(__('admin/general.track_manage_income')); ?></p>
                </div>
                    ...
                    <li>
                        <div class="am-payment_item">
                            ...
                            <div class="am-payment_item_info">
                                <h3><?php echo e(formatAmount($this->platformEarnings)); ?></h3>
                                <span><?php echo e(__('admin/general.platform_earnings')); ?></span>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="am-payment_item">
                            ...
                            <div class="am-payment_item_info">
                                <h3><?php echo e(formatAmount($this->tutorEarnings)); ?></h3>
                                <span><?php echo e(__('admin/general.tutor_payouts')); ?></span>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="am-payment_item">
                            ...
                            <div class="am-payment_item_info">
                                <h3><?php echo e(formatAmount($this->platformCommission)); ?></h3>
                                <span><?php echo e(__('admin/general.platform_commission')); ?></span>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="am-payment_item">
                            ...
                            <div class="am-payment_item_info">
                                <h3><?php echo e(formatAmount($this->tutorPendingEarnings)); ?></h3>
                                <span><?php echo e(__('admin/general.pending_payouts')); ?></span>
                            </div>
                        </div>
                    </li>
                </ul>
        ...
        <div class="am-insights_section am-engagement">
            <div class="am-insights_header">
                <div class="am-insights_title">
                    <h2><?php echo e(__('admin/general.session_engagement')); ?></h2>
                    <p><?php echo e(__('admin/general.track_manage_income')); ?></p>
                </div>
                <div class="am-insights_actions">
                    <em>Filter by:</em>
            ...
            <div class="am-insights_content">
                <ul class="am-payment_list">
                    <li>
                        <div class="am-payment_item">
                            <div class="am-payment_item_info">
                                <h3><?php echo e($this->totalSessions); ?></h3>
                                <span><?php echo e(__('admin/general.total_sessions_booked')); ?></span>
                            </div>
                            <div class="am-payment_item_icon">
                    ...
                    <li>
                        <div class="am-payment_item">
                            <div class="am-payment_item_info">
                                <h3><?php echo e($this->completedSessions); ?></h3>
                                <span><?php echo e(__('admin/general.completed_sessions')); ?></span>
                            </div>
                            <div class="am-payment_item_icon">
                    ...
                    <li>
                        <div class="am-payment_item">
                            <div class="am-payment_item_info">
                                <h3><?php echo e($this->cancelledSessions); ?></h3>
                                <span><?php echo e(__('admin/general.rescheduled_sessions')); ?></span>
                            </div>
                            <div class="am-payment_item_icon">
        ...
        <div class="am-insights_section am-activity">
            <div class="am-insights_header">
                <div class="am-insights_title">
                    <h2><?php echo e(__('admin/general.user_metrics_activity')); ?></h2>
                    <p><?php echo e(__('admin/general.track_manage_income')); ?></p>
                </div>
            </div>
            <div class="am-insights_content">
                <div class="am-activity_card">
                    <div class="am-activity_user">
                        <div class="am-activity_user_info">
                            <span><?php echo e(__('admin/general.total_users')); ?></span>
                            <strong><?php echo e($this->usersCount); ?></strong>
                        </div>
                        <!--[if BLOCK]><![endif]--><?php if($this->users->isNotEmpty()): ?>
                        <figure class="am-activity_user_img">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <!--[if BLOCK]><![endif]--><?php if(!empty($user->profile?->image) && Storage::disk(getStorageDisk())->exists($user->profile?->image)): ?>
                                    <img src="<?php echo e(url(Storage::url($user->profile?->image))); ?>" alt="<?php echo e($user->profile?->image); ?>">
                                <?php else: ?>
                                    <img src="<?php echo e(resizedImage('placeholder.png',34,34)); ?>" alt="<?php echo e($user->profile?->image); ?>" />
                    ...
                    <div class="am-activity_data">
                        <div class="am-activity_data_item">
                            <div class="am-activity_data_user">
                                <span>
                                <?php echo e($tutor_name); ?>

                                    <strong><?php echo e($this->tutorsCount); ?></strong>
                                </span>
                                <a href="<?php echo e(route('admin.users', ['role' => 'tutor'])); ?>" target="_blank" class="am-activity_data_user_link">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($this->tutors->isNotEmpty()): ?>   
                            <div class="am-activity_data_user_img">
                                <figure>
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->tutors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tutor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <!--[if BLOCK]><![endif]--><?php if(!empty($tutor->profile?->image) && Storage::disk(getStorageDisk())->exists($tutor->profile?->image)): ?>
                                            <img src="<?php echo e(url(Storage::url($tutor->profile?->image))); ?>" alt="<?php echo e($tutor->profile?->image); ?>">
                                        <?php else: ?>
                                            <img src="<?php echo e(resizedImage('placeholder.png',34,34)); ?>" alt="<?php echo e($tutor->profile?->image); ?>" />
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                </figure>
                                </div>
                        ...
                        <div class="am-activity_data_item">
                            <div class="am-activity_data_user">
                                ...
                                <?php echo e($student_name); ?>
                                    ...
                                    <strong><?php echo e($this->studentsCount); ?></strong>
                                </span>
                                
                                <a href="<?php echo e(route('admin.users', ['role' => 'student'])); ?>" target="_blank" class="am-activity_data_user_link">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none"><g opacity="0.6"><path d="M3.16675 13.8327L13.8334 3.16602M13.8334 3.16602V10.4993M13.8334 3.16602H6.50008" stroke="black" stroke-linecap="round" stroke-linejoin="round"/></g></svg>
                                </a>
                            </div>
                            <!--[if BLOCK]><![endif]--><?php if($this->students->isNotEmpty()): ?>
                            <div class="am-activity_data_user_img">
                                <figure>
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <!--[if BLOCK]><![endif]--><?php if(!empty($student->profile?->image) && Storage::disk(getStorageDisk())->exists($student->profile?->image)): ?>
                                            <img src="<?php echo e(url(Storage::url($student->profile?->image))); ?>" alt="<?php echo e($student->profile?->image); ?>">
                                        <?php else: ?>
                                            <img src="<?php echo e(resizedImage('placeholder.png',34,34)); ?>" alt="<?php echo e($student->profile?->image); ?>" />
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                </figure>
                            </div>
                ...
                <div class="am-activity_card am-activity_comparison_card">
                    <div class="am-activity_card_heading">
                        <h3><?php echo e(__('admin/general.monthly_user_comparison')); ?></h3>
                    </div>
                    <div class="am-activity_user_comparison">
                        <span>
                            <?php echo e(__('admin/general.this_month')); ?>

                            <strong class="<?php echo e($difference < 0? 'am-loss' : 'am-profit'); ?>">
                                <?php echo e(number_format($currentMonthUsers)); ?> <?php echo e(__('admin/general.users')); ?> 
                                <em><?php echo e($difference > 0 ? '+':''); ?><?php echo e($difference); ?>%</em>
                        ...
                        <span>
                            <?php echo e(__('admin/general.last_month')); ?>

                            <strong>
                                <?php echo e(number_format($lastMonthUsers)); ?> <?php echo e(__('admin/general.users')); ?> 
                            </strong>
                        </span>
                    </div>
                </div>
...
<script>
    document.addEventListener('livewire:initialized', function() {
        ...
        jQuery('#revenue-date-range').daterangepicker({
            ...
            locale: {
                cancelLabel: <?php echo json_encode(__('general.clear'), 15, 512) ?>
            },
        ...
        ,function(start, end, label) {
         ...
         $('#revenue-date-range').on('apply.daterangepicker', function(ev, picker) {
            window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('revenueStartDate', picker.startDate.format('YYYY-MM-DD'));
            window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('revenueEndDate', picker.endDate.format('YYYY-MM-DD'));
        });

         $('#session-date-range').on('apply.daterangepicker', function(ev, picker) {
            window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('sessionStartDate', picker.startDate.format('YYYY-MM-DD'));
            window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('sessionEndDate', picker.endDate.format('YYYY-MM-DD'));
        });

});
</script>
<?php $__env->stopPush(); ?><?php /**PATH /home/lexhwdfc/public_html/resources/views/livewire/pages/admin/insights/insights.blade.php ENDPATH**/ ?>