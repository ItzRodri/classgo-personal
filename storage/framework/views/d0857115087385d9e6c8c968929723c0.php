                    ...
                    <table class="tb-table <?php if(setting('_general.table_responsive') == 'yes'): ?> tb-table-responsive <?php endif; ?>">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if(!$isLoading): ?>
                            <tbody class="d-none" wire:loading.class.remove="d-none" wire:target="status,sortby,keyword">
                                <?php echo $__env->make('skeletons.admin-dispute', ['perPage' => $perPage], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </tbody>
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $disputes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dispute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td data-label="<?php echo e(__('dispute.session')); ?>">
                                                <div class="am-list-wrap">
                                                    <figure class="am-img-rounded">
                                                        <!--[if BLOCK]><![endif]--><?php if(!empty($dispute?->booking?->slot?->subjectGroupSubjects?->image) && Storage::disk('public')->exists($dispute?->booking?->slot?->subjectGroupSubjects?->image)): ?>
                                                        ...
                                                        <?php else: ?> 
                                                            <img src="<?php echo e(setting('_general.default_avatar_for_user') ? asset('storage/' . setting('_general.default_avatar_for_user')[0]['path']) : resizedImage('placeholder.png',34,34)); ?>" alt="<?php echo e($dispute?->booking?->slot?->subjectGroupSubjects?->image); ?>" />
                                            ...
                                            <td data-label="<?php echo e(__('dispute.student' )); ?>">
                                                <div class="am-list-wrap">
                                                    <figure>
                                                        <!--[if BLOCK]><![endif]--><?php if(!empty($dispute?->booking?->student?->image) && Storage::disk('public')->exists($dispute?->booking?->student?->image)): ?>
                                                        <img src="<?php echo e(resizedImage($dispute?->booking?->student?->image,34,34)); ?>" alt="<?php echo e($dispute?->booking?->student?->image); ?>" />
                                                        <?php else: ?>
                                                            <img src="<?php echo e(setting('_general.default_avatar_for_user') ? asset('storage/' . setting('_general.default_avatar_for_user')[0]['path']) : resizedImage('placeholder.png', 34, 34)); ?>" alt="<?php echo e($dispute?->booking?->student?->image); ?>" />
                                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                    </figure>
                                                    <span>
                                                        <span>
                                            ...
                                            <td data-label="<?php echo e(__('dispute.tutor' )); ?>">
                                                <div class="am-list-wrap">
                                                    <figure>
                                                        <!--[if BLOCK]><![endif]--><?php if(!empty($dispute?->booking?->tutor?->image) && Storage::disk('public')->exists($dispute?->booking?->tutor?->image)): ?>
                                                        <img src="<?php echo e(resizedImage($dispute?->booking?->tutor?->image,34,34)); ?>" alt="<?php echo e($dispute?->booking?->tutor?->image); ?>" />
                                                        <?php else: ?> 
                                                            <img src="<?php echo e(setting('_general.default_avatar_for_user') ? asset('storage/' . setting('_general.default_avatar_for_user')[0]['path']) : resizedImage('placeholder.png',34,34)); ?>" alt="<?php echo e($dispute?->booking?->tutor?->image); ?>" />
                                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                    </figure>
                                                    <span>
                                                        <span>
...
</main><?php /**PATH /home/lexhwdfc/public_html/resources/views/livewire/pages/admin/dispute/dispute.blade.php ENDPATH**/ ?>