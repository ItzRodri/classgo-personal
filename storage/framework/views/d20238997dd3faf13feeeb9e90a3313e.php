<div class="am-profile-setting" wire:init="loadData" wire:key="window.Livewire.find('<?php echo e($_instance->getId()); ?>')">
    ...
    <?php $__env->endSlot(); ?>
    <?php echo $__env->make('livewire.pages.tutor.manage-sessions.tabs', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <div x-data="{search:'', sessionData: <?php if ((object) ('form') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('form'->value()); ?>')<?php echo e('form'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('form'); ?>')<?php endif; ?>}" class="am-userperinfo">
        <!--[if BLOCK]><![endif]--><?php if($isLoading): ?>
            <?php echo $__env->make('skeletons.manage-subject', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php else: ?>
                            ...
                            <div class="am-subject-heading">
                                ...
                                <div class="am-itemdropdown">
                                    ...
                                    <ul class="am-itemdropdown_list dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        ...
                                        <li>
                                            <a href="javascript:void(0);" @click="$wire.dispatch('showConfirm', { groupId: <?php echo e($group?->id); ?>, action : 'delete-user-subject-group' })">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $group?->subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li wire:key="subject-<?php echo e($subject?->pivot->id); ?>" wire:sortable-group.item="<?php echo e($subject?->pivot->id); ?>">
                                                    ...
                                                    <div class="am-subject-list_content">
                                                        <figure>
                                                            <!--[if BLOCK]><![endif]--><?php if(!empty($subject->pivot->image)): ?>
                                                                <img src="<?php echo e(url(Storage::url($subject->pivot->image))); ?>" alt="profile">
                                                            <?php elseif(setting('_general.default_avatar_for_user')): ?>
                                                                <img src="<?php echo e(url(Storage::url(setting('_general.default_avatar_for_user')[0]['path']))); ?>" alt="profile">
                                                            <?php else: ?>
                                                                <img src="<?php echo e(asset('demo-content/placeholders/placeholder-land.png')); ?>" alt="profile">
                                                        ...
                                                        <div class="am-subject-info">
                                                            <div class="am-subject-info_content">
                                                                <div class="am-subject-detail">
                                                                    <div class="am-subject_content">
                                                                        ...
                                                                        <div class="am-itemdropdown">
                                                                            ...
                                                                            <ul class="am-itemdropdown_list dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                                ...
                                                                                <li>
                                                                                    <a href="javascript:void(0);" @click="$wire.dispatch('showConfirm', { groupId: <?php echo e($group?->id); ?>, subjectId : <?php echo e($subject?->pivot->id); ?>, action : 'delete-user-subject' })">
                                                                                        <i class="am-icon-trash-02"></i>
                                                                                        <?php echo e(__('general.delete')); ?>
                                                                    ...
                                                                    <?php echo $subject?->pivot?->description; ?>

                                                                </div>
                                                            </div>
                                                            <!--[if BLOCK]><![endif]--><?php if(!empty($subject->description)): ?>
                    ...
                    <div class="am-modal-body">
                        <form class="am-themeform am-subject-form">
                            <fieldset>
                                ...
                                >
                                    <label class="am-label am-important2">
                            ...
                            <fieldset>
                                <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['form-group', 'am-invalid' => $errors->has('form.subject_id')]); ?>">
                                    ...
                                    <span class="am-select" wire:ignore>
                                        <select data-componentid="window.Livewire.find('<?php echo e($_instance->getId()); ?>')" class="am-select2" data-searchable="true" id="subjects" data-wiremodel="form.subject_id" data-placeholder="<?php echo e(__('subject.select_subject')); ?>"></select>
                                    </span>
                                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
                                ...
                                <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['form-group', 'am-invalid' => $errors->has('form.hour_rate')]); ?>">
                                    <label class="am-label am-important2"><?php echo e(__('subject.session_price')); ?></label>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['class' => 'am-important2','for' => 'introduction','value' => __('subject.breif_introduction')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'am-important2','for' => 'introduction','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('subject.breif_introduction'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/lexhwdfc/public_html/resources/views/livewire/pages/tutor/manage-sessions/manage-subjects.blade.php ENDPATH**/ ?>