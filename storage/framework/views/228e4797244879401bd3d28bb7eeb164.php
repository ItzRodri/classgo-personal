                                    ...
                                    <td>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if(!empty($availableSlots[parseToUserTz($startOfCalendar)->toDateString()])): ?>
                                            ...
                                            <div class="am-slots-count">
                                                <em> <strong><?php echo e($availableSeats); ?></strong>/ <?php echo e($availableSlots[parseToUserTz($startOfCalendar)->toDateString()]['all_slots']); ?> <?php echo e(__('calendar.spaces_left')); ?></em>
...
<?php endif; ?>
                                ...
                                <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['form-group', 'form-group-half', 'am-invalid' => $errors->has('form.date_range')]); ?>">
                                    <label class="am-label am-important2"><?php echo e(__('calendar.start_end_date')); ?></label>
                                    <span class="am-select">
                                        <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['wire:model' => 'form.date_range','class' => 'flat-date','placeholder' => ''.e(__('calendar.start_end_date_placeholder')).'','dataMinDate' => 'today','dataMode' => 'range','dataFormat' => 'Y-m-d','id' => 'session-range']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'form.date_range','class' => 'flat-date','placeholder' => ''.e(__('calendar.start_end_date_placeholder')).'','data-min-date' => 'today','data-mode' => 'range','data-format' => 'Y-m-d','id' => 'session-range']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                ...
                                <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['form-group', 'form-group-half', 'am-invalid' => $errors->has('form.end_time') || $errors->has('form.end_time')]); ?>">
                                    <label class="am-label am-important2"><?php echo e(__('calendar.start_end_time')); ?></label>
                                    <div class="am-dropdown am-startend-date" x-data="{
                                        ...
                                        <div class="dropdown-menu booking-time">
                                            <ul class="am-dropdownlist">
                                                <li>
                                                    <label class="am-label am-important2"><?php echo e(__('calendar.start_time')); ?></label>
                                                    <span class="am-select" wire:ignore>
                                                ...
                                                <li>
                                                    <label class="am-label am-important2"><?php echo e(__('calendar.end_time')); ?></label>
                                                    <span class="am-select" wire:ignore>
...
<?php endif; ?>
                                ...
                                <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['form-group', 'form-group-half', 'am-invalid' => $errors->has('form.duration')]); ?>">
                                    <label class="am-label am-important2"><?php echo e(__('calendar.session_duration')); ?></label>
                                    <span class="am-select" wire:ignore>
...
<?php endif; ?>
                                ...
                                <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['form-group', 'form-group-half', 'am-invalid' => $errors->has('form.break')]); ?>">
                                    <label class="am-label am-important2"><?php echo e(__('calendar.break_time')); ?></label>
                                    <span class="am-select" wire:ignore>
...
<?php endif; ?>
                                ...
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                <!--[if BLOCK]><![endif]--><?php if(\Nwidart\Modules\Facades\Module::has('subscriptions') && \Nwidart\Modules\Facades\Module::isEnabled('subscriptions')): ?>
                                ...
                                <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['form-group', 'form-group-half', 'am-invalid' => $errors->has('form.session_fee')]); ?>">
                                    <label class="am-label am-important2"><?php echo e(__('calendar.session_fee')); ?></label>
                                    <div class="am-addfee">
                                        <input type="text" wire:model="form.session_fee" class="form-control" placeholder="<?php echo e(__('calendar.session_fee_placeholder')); ?>" />
...
<?php endif; ?>
                                ...
                                <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['form-group', 'am-invalid' => $errors->has('form.description')]); ?>">
                                    <div class="am-label-wrap">
                                        <label class="am-label am-important2"><?php echo e(__('calendar.session_description')); ?></label>
...
<?php $__env->stopPush(); ?>
    ...
    ?><?php /**PATH /home/lexhwdfc/public_html/resources/views/livewire/pages/tutor/manage-sessions/my-calendar.blade.php ENDPATH**/ ?>