...
<?php endif; ?>
                                    ...
                                    <?php if(!empty($tutor?->profile?->tagline)): ?>
                                        <span><?php echo e($tutor?->profile?->tagline); ?></span>
                                    <?php endif; ?>
                                </div>
                            </div>
                                ...
                                <ul class="am-tutorreviews-list">
                                    ...
                                    <li>
                                        <div class="am-tutorreview-item">
                                            ...
                                            <?php echo e($tutor?->active_students == '1' ? __('tutor?.active_student') :
                                    ...
                                    <li>
                                        <div class="am-tutorreview-item">
                                            ...
                                            <span><?php echo e($totalSlots); ?> <em><?php echo e($totalSlots == 1 ? __('tutor.session') :
                                                __('tutor.sessions')); ?></em></span>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="am-tutorreview-item">
                                    ...
                                    <li>
                                        ...
                                        <ul x-data="{ open: false }">
                                                ...
                                                <?php $__currentLoopData = $tutor?->subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($index < 2): ?> 
                                                        <li><span><?php echo e($sub->subject?->name); ?></span></li>
                                                    <?php else: ?>
                                                        <li x-show="open"><span><?php echo e($sub->subject?->name); ?></span></li>
                                                    <?php endif; ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-788052715-0', $__slots ?? [], get_defined_vars());
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                                            ...
                                            <li class="splide__slide">
                                                <div class="cr-card">
                                                    <figure 
                                                        ...
                                                        <?php if(!empty($course?->promotionalVideo?->path) && Storage::disk('public')->exists($course?->promotionalVideo?->path) ): ?>
                                                            <template x-if="!isOpen">
                                                                <figcaption>
                        ...
                        <?php else: ?>
                            <?php echo $__env->make('livewire.components.no-record', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-788052715-1', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-788052715-2', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-788052715-3', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('layouts.frontend-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lexhwdfc/public_html/resources/views/frontend/tutor-detail.blade.php ENDPATH**/ ?>