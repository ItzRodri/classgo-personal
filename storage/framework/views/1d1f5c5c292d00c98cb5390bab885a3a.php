                    ...
                    <div class="am-limitless-features-box" data-aos="fade-up" data-aos-easing="ease" data-aos-delay="400">
                        <?php if(!empty(pagesetting('heading')) 
                            ...
                            <div class="am-limitless-features-content">
                                ...
                                <?php if(!empty(pagesetting('paragraph'))): ?><p data-aos="fade-up" data-aos-easing="ease" data-aos-delay="700"><?php echo e(pagesetting('paragraph')); ?></p><?php endif; ?>
                                <?php if(!empty(pagesetting('btn_txt'))): ?>
                                    <a href="<?php if(!empty(pagesetting('btn_url'))): ?> <?php echo e(pagesetting('btn_url')); ?> <?php endif; ?>" class="am-btn" data-aos="fade-up" data-aos-easing="ease" data-aos-delay="800"><?php echo e(pagesetting('btn_txt')); ?></a>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
...
<?php /**PATH /home/lexhwdfc/public_html/resources/views/pagebuilder/limitless-features/view.blade.php ENDPATH**/ ?>