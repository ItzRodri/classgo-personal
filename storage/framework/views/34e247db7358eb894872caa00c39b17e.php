                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="<?php echo e(__('admin/general.role')); ?>">
                                    <?php echo e(ucfirst( $single->roles()->first()->name )); ?>
                                ...
                                <td  data-label="<?php echo e(__('general.actions')); ?>">
                                    <div class="am-custom-tooltip">
                                        ...
                                        <i @click="$wire.dispatch('showConfirm', { id : <?php echo e($single->id); ?>, content: '<?php echo e(__('general.delete_user')); ?>', action : 'delete-user' })" class="icon-trash-2"></i>
                                    </div> 
                                    <div class="am-custom-tooltip am-tooltip-textimp">
                                        ...
                                        <i @click="$wire.dispatch('showConfirm', { id : <?php echo e($single->id); ?>, action : 'impersonate-user' })" class="icon-eye"></i>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div> 
                                </td>
                            </tr>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div class="form-group tb-formbtn">
                                        <button class="tb-btn" type="submit" wire:target="addUser"
                                            wire:loading.class="am-btn_disable"><?php echo e(__('general.save_user')); ?></button>
                                    </div>
                                </div>
                            </fieldset>
                        </form>
...
</main><?php /**PATH /home/lexhwdfc/public_html/resources/views/livewire/pages/admin/users/users.blade.php ENDPATH**/ ?>