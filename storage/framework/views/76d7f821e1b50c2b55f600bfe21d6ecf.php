...
<script>
    ...
    noUiSlider.create(boxed_slider, {
        ...
        range: {
            'min': [0],
            'max': [<?php echo e((empty($styles['boxed_slider_input'])?'1320':$styles['boxed_slider_input'])); ?>]
        }
    });
...
</script><?php /**PATH /home/lexhwdfc/public_html/vendor/larabuild/pagebuilder/src/../resources/views/components/styles.blade.php ENDPATH**/ ?>