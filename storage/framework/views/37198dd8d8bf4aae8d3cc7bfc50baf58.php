                        ...
                        <?php if(!empty(pagesetting('pre_heading')) 
                            ...
                            <div class="am-marketplace_content_list">
                                ...
                                <?php if(!empty(pagesetting('get_start_btn_text'))): ?> 
                                    <a href="<?php if(!empty(pagesetting('get_start_btn_url'))): ?> <?php echo e(pagesetting('get_start_btn_url')); ?> <?php endif; ?>" class="am-marketplace_content_list_btn">
...
</section><?php /**PATH /home/lexhwdfc/public_html/resources/views/pagebuilder/marketplace/view.blade.php ENDPATH**/ ?>