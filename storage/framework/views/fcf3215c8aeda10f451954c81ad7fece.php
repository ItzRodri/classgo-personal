                                ...
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $single): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td data-label="<?php echo e(__('identity.gaurdian_info' )); ?>">
                                            <span>
                                                <?php echo e($single?->parent_name ?? '-'); ?> <br>
                                                <?php echo e($single?->parent_phone); ?> <br>
                                                <?php echo e($single?->parent_email); ?><br>
                                                <?php echo e($single->parent_verified_at && "Verified"); ?>

                                            </span>
                                        </td>
                                        <td data-label="<?php echo e(__('identity.school_info' )); ?>">
                                            <span>
                                                <?php echo e($single?->school_id ?? '-'); ?> <br>
                                                <?php echo e($single?->school_name); ?>
                                        ...
                                        <td data-label="<?php echo e(__('identity.status' )); ?>">
                                            <div class="am-status-tag">
                                                <em class="tk-project-tag <?php echo e($single?->profile?->recommend_tutor == 'accepted' ? 'tk-hourly-tag' : 'tk-fixed-tag'); ?>"><?php echo e($single?->status); ?></em>
                                            </div>
                                        </td>
...
</main><?php /**PATH /home/lexhwdfc/public_html/resources/views/livewire/pages/admin/identity-verification/identitiy_verification.blade.php ENDPATH**/ ?>