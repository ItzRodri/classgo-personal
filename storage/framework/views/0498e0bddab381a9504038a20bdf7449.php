...
<div class="pb-bodywrapper">
    ...
    <main class="pb-main larabuild-grid1">
        <iframe id="pagebuilder-iframe" allowfullscreen="1" src="<?php echo e(URL('pages/'.$page->id.'/iframe')); ?>" frameborder="0"></iframe>
    </main>
</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('pagebuilder::layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lexhwdfc/public_html/vendor/larabuild/pagebuilder/src/../resources/views/pagebuilder.blade.php ENDPATH**/ ?>