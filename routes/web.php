...
Route::middleware(['locale', 'maintenance'])->group(function () {
    ...
    Route::middleware(['auth', 'verified', 'onlineUser'])->group(function () {
        ...
        Route::get('/create-meeting', [GoogleMeetController::class, 'createMeeting'])->name('meet.create');
        Route::get('google/callback', [GoogleMeetController::class, 'callback'])->name('google.callback');
